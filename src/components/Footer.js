                    ...
                    <div className="grid sm:grid-cols-12 gap-5 py-8 md:py-12 border-t border-gray-200 lg:ml-11">
                        ...
                        <div className="col-span-12 lg:col-span-3">
                            <div className="box-border border-b-4 border-blue-900 p-8 bg-gray-200 text-gray-600 text-center rounded-lg xl:w-80 mx-auto">
                                <h3 className="font-bold text-4xl mb-4">Sylabiz</h3>
                        ...
                        <div className="col-span-6 md:col-span-6 lg:col-span-2 ml-7 mx-auto">
                            <h6 className="text-[#013289] text-5xl font-bold mb-4">LINKS</h6>
                        ...
                        {/* 3rd block: Social Media Links */}
                        <div className="col-span-12 lg:col-span-7 font-bold uppercase text-blue-900 flex flex-col items-center justify-center h-80">
                            ...
                            <div className="mx-auto text-center mt-2 flex-grow">
                                <ul className="flex justify-center mb-4 md:mb-0 space-x-12">
                                    <li>
                                        <Link to="#" className="flex justify-center items-center text-blue-900 hover:text-gray-500 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Twitter">
                                            <svg className="w-16 h-16 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
