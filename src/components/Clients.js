...
import kws from '../images/clients/UT.png';
import geps from '../images/clients/MIT.png';
import protergia from '../images/clients/Berkeley.png';
        ...
        <div className="mt-8 bg-gray-100">
            <section data-aos="fade-up">
                <div className="my-4 py-4">
                        <h2 className="my-2 text-center text-3xl text-blue-900 font-bold">Used by students who attend</h2>
