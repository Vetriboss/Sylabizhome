                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            {/* We build digital solutions to help businesses scale */}
                                Helping College Students One Syllabus At a Time
                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">We aim to simplify the tedious and crucial tasks that can make or break a students performace in a college course through the power of automation.
                            </div>
