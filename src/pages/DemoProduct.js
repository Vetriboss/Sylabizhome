                        ...
                        <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                            ...
                            <div className="flex items-center my-4">
                                <input 
                                    ...
                                    value="Sylabiz" onChange={handleChange}
                                />
                                <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">Sylabiz</label>
                            </div>
                            {errors && 
                    ...
                    <div className="w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-blue-900 rounded-2xl">
                        <div className="flex flex-col text-white">     
                            <div className="flex my-4 w-2/3 lg:w-3/4">
                                ...
                                <div className="flex flex-col">
                                    <h2 className="text-2xl">Office Email</h2>
                                    <p className="text-gray-400">Sylabiz@gmail.com</p>
                                </div>
                            </div>
